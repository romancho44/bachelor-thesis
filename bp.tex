...
\abstract{Vozka R. Implementation of backend modules and subsequent design and implementation of module Timeline for needs of Gamificated Information System. Brno, 2020}
{Thesis describes implementation of backend modules for the web application of gamificated information system.
...
\obrazek
\vlozobr{bakalarska-prace/spring-overview}{0.6}
  ...
  "paths": {
    "/timeline/events": {
      "get": {
        ...
        "summary": "Service for retrieving players in game important events",
 ...
 "definitions": {
    "EventDto": {
      ...
      "properties": {
        ...
        "title": {
          "type": "string",
          "example": "Mise {{missionTitle}} splněna."
        },
        "eventTypeCode": {
          "type": "string",
          "example": "missionCompleted",
          "description": "NotificationType.code"
        },
        "created": {
          "type": "string",
          "example": "2019-11-10 11:08:50"
        }
      }
    }
  }
...
\podsekce{Filtrovací databázový predikát -- použití knihovny QueryDSL}
