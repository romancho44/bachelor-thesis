...
\prohlasenimuz{Brno, 18. května 2020}


\abstract{Vozka R. Implementation of backend modules and subsequent design and implementation of timeline module for needs of gamified information system. Brno, 2020}
{Thesis describes the implementation of backend modules for the web application of gamified information system.
In the thesis are introduced various concepts of web technologies, concept of gamification and interestingness of its application
to the information system. With the use of this concepts backend modules has been created.}

\keywords{backend, gamification, information system, Java, Spring Framework, REST, web technologies}
...
\obrzdroj{Zakresleno pomocí volně dostupného nástroje draw.io}}
...
\sekce{Služba pro získaní důležitých událostí hráče}
...
\obrazek
\vlozobr{bakalarska-prace/entity-class-diagram-timeline.png}{0.47}
...
\obrzdroj{Zakresleno pomocí programu Enterprise Architect}}
...
\hline
\end{tabular}
\tabzdroj{Výsledky funkce LoadTest, programu SoapUI}
\endtab
